...
// backdrop. A few cells gently pulse orange (see .lf-grid-cell in globals.css).
    ...
    for (let c = 0; c < cols; c++) {
      ...
      cells.push(
        <rect
          ...
          height={12}
          rx={2.5}
          fill={lit ? "#ffa116" : "#2a2115"}
          className={lit ? "lf-grid-cell" : undefined}
          style={lit ? { ["--lf-dur" as string]: `${2.4 + seed * 0.4}s` } : undefined}
        />,
      );
    }
  }
...
export default function Background() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden bg-bg">
      {/* orange ambient — the "action" color, top spotlight */}
      <div
        ...
        style={{
          ...
          height: "92%",
          background:
            "radial-gradient(50% 62% at 50% 0%, rgba(255,161,22,.16), rgba(20,16,12,.2) 46%, rgba(20,16,12,0) 72%)",
        }}
      />
      {/* left warm wash */}
      <div
        ...
        style={{
          ...
          width: "38%",
          height: "78%",
          background: "radial-gradient(closest-side, rgba(224,132,10,.12), transparent 72%)",
          filter: "blur(18px)",
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(60% 100% at 50% 100%, rgba(2,2,2,.85), transparent 72%)",
        }}
      />
      {/* submission-grid motif, faint along the bottom */}
      <div
