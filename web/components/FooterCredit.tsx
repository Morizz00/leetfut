...
// Footer author credit — "Built by  @younesfdj ✕  &  @wassim_khouas ✕". Purely
// the maker credit — no repo-star CTA (LeetFut has no GitHub-star equivalent).
// Shared by the home footer (AppShell) and the scout-report footer (ResultView)
// so they match. A soft dark backdrop lifts the credit off the submission-grid
