...
const LADDER = [
  ...
  { label: "RED", bg: "#221016", ink: "#ff6273" },
  { label: "IN-FORM", bg: "#4A0A14", ink: "#FFD3D9" },
  { label: "CHROME", bg: "#221016", ink: "#d8dde3" },
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(90deg, transparent, rgba(255,161,22,.55), transparent)" }}
        />
        ...
        <p className="m-0 mt-[15px] max-w-[47ch] text-[14.5px] leading-[1.55] text-ink-dim">
          Six signals off your live LeetCode profile, weighed against each other to find your shape. That shape is
          your card — so two devs with the same numbers still walk out different. Here&apos;s how to read yours.
        </p>
        ...
        <div className="mt-[24px] border-t border-white/[0.08] pt-[20px]">
          ...
          <p className="m-0 mt-[16px] text-[12px] leading-[1.5] text-ink-mute">
            Read live from your public LeetCode profile. No inputs, no edits — just the tape.
          </p>
        </div>
      </div>
    </div>
