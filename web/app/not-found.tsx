...
export const metadata: Metadata = {
  title: "404 · Offside — LeetFut",
  robots: { index: false },
};

// The assistant referee's flag, drawn in the brand orange check (not the usual
...
function OffsideFlag() {
  return (
    <svg
      ...
      fill="none"
      aria-hidden
      style={{ filter: "drop-shadow(0 6px 16px rgba(255,161,22,.35))" }}
    >
      <defs>
        <pattern id="offside-check" width="22" height="22" patternUnits="userSpaceOnUse">
          <rect width="22" height="22" fill="#ffa116" />
          <rect width="11" height="11" fill="#2b1c06" />
          <rect x="11" y="11" width="11" height="11" fill="#2b1c06" />
        </pattern>
      </defs>
    ...
    <div className="relative min-h-screen overflow-x-hidden text-ink">
      ...
      <main className="relative z-[2] mx-auto flex min-h-screen max-w-[600px] flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-[14px]">
          <Link
            href="/"
            className="font-display inline-flex h-[46px] items-center rounded-xl bg-brand px-7 text-[16px] tracking-[.06em] text-[#1a0f00] transition hover:bg-brand-hi focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
          >
            BACK TO THE PITCH
          </Link>
          <Link
