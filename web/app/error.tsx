...
// a bad render, or an upstream failure that isn't a clean API error the page
    ...
    <div className="relative min-h-screen overflow-x-hidden text-ink">
      ...
      <main className="relative z-[2] mx-auto flex min-h-screen max-w-[560px] flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-7 flex items-center gap-3">
          <button
            onClick={reset}
            className="font-display inline-flex h-[46px] items-center rounded-xl bg-brand px-6 text-[16px] tracking-[.06em] text-[#1a0f00] transition hover:bg-brand-hi"
          >
            TRY AGAIN
          </button>
          <Link
